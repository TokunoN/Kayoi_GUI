...
# ログ出力をするため、実行ファイルをshに統一。
# その影響でcronもshファイルから実行することになった。
# command_list = [
#     "python3 ~/Desktop/Kayoi_GUI/Kayoi/I2C/py/AmbientWriteData.py",
#     "python3 ~/Desktop/Kayoi_GUI/Kayoi/I2C/py/notifyLINE_alert.py",
#     "python3 ~/Desktop/Kayoi_GUI/Kayoi/I2C/py/notifyLINE_period.py",
#     "python3 ~/Desktop/Kayoi_GUI/Kayoi/I2C/py/AmbientReadData.py",
#     "python3 ~/Desktop/Kayoi_GUI/Kayoi/I2C/py/daily_report.py",
#     "python3 ~/Desktop/Kayoi_GUI/Kayoi/I2C/py/I2C_data_period_gzip.py"
# ]

command_list = [
    f"sh {get_filepath('../sh/90_test_AmbientWriteData.sh')} >> $HOME/Desktop/Kayoi_GUI/Kayoi/I2C/cron_stderr.log 2>&1",
    f"sh {get_filepath('../sh/92_test_LINE_Notify_alert.sh')} >> $HOME/Desktop/Kayoi_GUI/Kayoi/I2C/cron_stderr.log 2>&1",
    f"sh {get_filepath('../sh/93_test_LINE_Notify_period.sh')} >> $HOME/Desktop/Kayoi_GUI/Kayoi/I2C/cron_stderr.log 2>&1",
    f"sh {get_filepath('../sh/91_test_AmbientReadData.sh')} >> $HOME/Desktop/Kayoi_GUI/Kayoi/I2C/cron_stderr.log 2>&1",
    f"sh {get_filepath('../sh/94_test_daily_report.sh')} >> $HOME/Desktop/Kayoi_GUI/Kayoi/I2C/cron_stderr.log 2>&1",
    f"sh {get_filepath('../sh/95_test_I2C_data_period_gzip.sh')} >> $HOME/Desktop/Kayoi_GUI/Kayoi/I2C/cron_stderr.log 2>&1",
]

job_start_minute_list = [0,1,2,1,3,4]
